...
function Header({ onContactClick }) {
  ...
  return (
    ...
    >
      ...
      {open && (
        <div className="lg:hidden flex flex-col gap-4 px-5 pb-5">
          {links.map((l, i) => (
            <span
              key={l}
              role="link"
...
function PropertyManagement() {
  ...
  return (
    <section style={{ background: C.navy }} className="py-14">
...
function DigitalMarketing() {
  ...
  return (
    <section style={{ background: C.lightBg }} className="py-16">
...
function CtaBar({ onContactClick }) {
  return (
    <section style={{ background: C.navy2 }} className="py-6">
